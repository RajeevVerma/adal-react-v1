...
<p align="center">
  <a href="https://www.npmjs.com/package/adal-react"><img src="https://img.shields.io/npm/v/react-adal.svg?style=flat-square"></a>
  <a href="https://www.npmjs.com/package/react-adal"><img src="https://img.shields.io/npm/dt/react-adal.svg?style=flat-square"></a>
</p>

# adal-react
Azure Active Directory Library (ADAL) support for ReactJS with silent renew token fix

@Source from react-adal. Credit salvoravida.

New NPM package created just to have this silent token renew fix which was not working without handleWindowCallback not registering it for iframe.

Looks like react-adal is not getting maintained anymore.

```
npm install adal-react
```
