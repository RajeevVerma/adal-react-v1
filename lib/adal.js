  ...
  */
  ...
  _AuthenticationContext.prototype._addAdalFrame = function (iframeId) {
    if (typeof iframeId === 'undefined') {
      this.log('Add adal frame to document:' + iframeId);
      return;
    }
    this.log('Add adal frame to document:' + iframeId);
    ...
    var handleFrameCallback = function handleFrameCallback() {
      if (adalFrame) {
        self.handleWindowCallback(adalFrame.contentWindow.location.hash);
        this.log("handleFrameCallback added to iframe ", adalFrame.contentWindow.location.hash);
      }
    };
    if (!adalFrame) {
